<?php
	...
	if(isset($_POST['new_reply'])) {
		...
		if(isset($new_reply_text)) {
			mysqli_query($this->connect, "INSERT INTO `children` (`user`, `text`, `date`, `par_code`) VALUES ('$new_reply_name', '$new_reply_text', '$new_reply_date', '$new_reply_code')") or die(mysqli_error());
		}
		header("Location: ");
	}
?>